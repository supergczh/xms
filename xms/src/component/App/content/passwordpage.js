...
class Passpage extends Component {
    ...
    createPage(totalPage, currentPage) {
        ...
        pages.push(<Link  onClick={this.prePageHandeler.bind(this)}
            to={{
                ...
                pathname: `/index/userpass/${currentPage-1}`
            }} 
                       key={0}>
        ...
        if (totalPage <= 5) {
            ...
            pages.push(<Link  key={totalPage}
                to={{
                    state: { id: totalPage },
                    pathname: `/index/userpass/${totalPage}`
                }} 
    ...
    pageClick(currentPage) {
        ...
        let { administrators, onf2, finduser, finduserpage, search} = this.props
...
}, (dispatch) => bindActionCreators(actionCreators, dispatch))(Passpage) 

    ...
    createPage(totalPage, currentPage) {
        ...
        pages.push(<Link  onClick={this.prePageHandeler.bind(this)}
            to={{
                ...
                pathname: `/index/users/${currentPage-1}`
            }} 
                       key={0}>
        ...
        if (totalPage <= 5) {
            ...
            pages.push(<Link  key={totalPage}
                to={{
                    state: { id: totalPage },
                    pathname: `/index/users/${totalPage}`
                }} 
...
}, (dispatch) => bindActionCreators(actionCreators, dispatch))(UserPage) 
